...
var G__14084 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14084,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14084;
}
}));
...
var len__4736__auto___14089 = arguments.length;
var i__4737__auto___14090 = (0);
while(true){
if((i__4737__auto___14090 < len__4736__auto___14089)){
args__4742__auto__.push((arguments[i__4737__auto___14090]));

var G__14091 = (i__4737__auto___14090 + (1));
i__4737__auto___14090 = G__14091;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14086){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14087,G__14088,seq14086__$2);
}));
...
var map__14093 = m;
var map__14093__$1 = (((((!((map__14093 == null))))?(((((map__14093.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14093.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14093):map__14093);
var file = cljs.core.get.call(null,map__14093__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14093__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14093__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__14092_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14092_SHARP_));
...
var temp__5720__auto___14095 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___14095)){
var message_14096 = temp__5720__auto___14095;
cljs.core.println.call(null,message_14096);
} else {
}
...
var temp__5720__auto___14097 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___14097)){
var message_14098 = temp__5720__auto___14097;
cljs.core.println.call(null,message_14098);
} else {
}
...
var output_dir__$1 = (function (){var G__14099 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__14099,"/"].join('');
} else {
return G__14099;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__14101 = exception.stack;
var G__14101__$1 = (((G__14101 == null))?null:clojure.string.split_lines.call(null,G__14101));
var G__14101__$2 = (((G__14101__$1 == null))?null:cljs.core.get.call(null,G__14101__$1,depth));
if((G__14101__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14101__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__14102 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14102,(0),null);
var column = cljs.core.nth.call(null,vec__14102,(1),null);
var vec__14105 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14105,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14105,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14105,(2),null);
...
var m__$1 = (function (){var G__14108 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14112 = (function (){var G__14111 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14111);
} else {
return G__14111;
}
})();
...
return cljs.core.vary_meta.call(null,G__14113,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14117 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14117,(0),null);
var types = vec__14117;
...
return cljs.core.map.call(null,(function (p__14120){
var vec__14121 = p__14120;
var ns = cljs.core.nth.call(null,vec__14121,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14121,(1),null);
return (function (){
...
var G__14124 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__14124__$1 = (((G__14124 instanceof cljs.core.Keyword))?G__14124.fqn:null);
switch (G__14124__$1) {
case "async":
...
var seq__14125 = cljs.core.seq.call(null,vars__$1);
var chunk__14126 = null;
var count__14127 = (0);
var i__14128 = (0);
while(true){
if((i__14128 < count__14127)){
var v = cljs.core._nth.call(null,chunk__14126,i__14128);
var temp__5720__auto___14130 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___14130)){
var t_14131 = temp__5720__auto___14130;
each_fixture_fn.call(null,((function (seq__14125,chunk__14126,count__14127,i__14128,t_14131,temp__5720__auto___14130,v,each_fixture_fn,G__14124,G__14124__$1,env,once_fixtures,each_fixtures,vec__14121,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14131)));
});})(seq__14125,chunk__14126,count__14127,i__14128,t_14131,temp__5720__auto___14130,v,each_fixture_fn,G__14124,G__14124__$1,env,once_fixtures,each_fixtures,vec__14121,ns,vars__$1))
);
} else {
}


var G__14132 = seq__14125;
var G__14133 = chunk__14126;
var G__14134 = count__14127;
var G__14135 = (i__14128 + (1));
seq__14125 = G__14132;
chunk__14126 = G__14133;
count__14127 = G__14134;
i__14128 = G__14135;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__14125);
if(temp__5720__auto__){
var seq__14125__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14125__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__14125__$1);
var G__14136 = cljs.core.chunk_rest.call(null,seq__14125__$1);
var G__14137 = c__4556__auto__;
var G__14138 = cljs.core.count.call(null,c__4556__auto__);
var G__14139 = (0);
seq__14125 = G__14136;
...
var v = cljs.core.first.call(null,seq__14125__$1);
var temp__5720__auto___14140__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___14140__$1)){
var t_14141 = temp__5720__auto___14140__$1;
each_fixture_fn.call(null,((function (seq__14125,chunk__14126,count__14127,i__14128,t_14141,temp__5720__auto___14140__$1,v,seq__14125__$1,temp__5720__auto__,each_fixture_fn,G__14124,G__14124__$1,env,once_fixtures,each_fixtures,vec__14121,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14141)));
});})(seq__14125,chunk__14126,count__14127,i__14128,t_14141,temp__5720__auto___14140__$1,v,seq__14125__$1,temp__5720__auto__,each_fixture_fn,G__14124,G__14124__$1,env,once_fixtures,each_fixtures,vec__14121,ns,vars__$1))
);
} else {
}


var G__14142 = cljs.core.next.call(null,seq__14125__$1);
var G__14143 = null;
var G__14144 = (0);
var G__14145 = (0);
seq__14125 = G__14142;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14124__$1)].join('')));
