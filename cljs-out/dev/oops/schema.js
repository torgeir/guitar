...
var G__15247 = cljs.core.first(element_str);
switch (G__15247) {
case "?":
arr.push((1));
...
var G__15249 = cljs.core.next(items);
items = G__15249;
continue;
} else {
return null;
...
var G__15250 = cljs.core.next(items);
items = G__15250;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__15252 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__15252) : is_valid_QMARK_.call(null,G__15252));
})())){
var G__15253 = cljs.core.next(cljs.core.next(items));
items = G__15253;
continue;
} else {
return true;
...
switch (G__15256) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__15254_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15254_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__15255_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15255_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15256)].join('')));
