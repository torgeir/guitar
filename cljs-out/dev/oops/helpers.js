...
var G__15021 = cljs.core.next(items);
items = G__15021;
continue;
} else {
return arr;
...
var x15022 = error;
(x15022.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x15022.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__15023 = Object.getPrototypeOf(o);
o = G__15023;
continue;
} else {
...
var or__4126__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5724__auto__ = (goog.global["devtools"]);
