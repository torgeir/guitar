...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__25905){
...
var clojure$data$EqualityPartition$equality_partition$dyn_25915 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_25915(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_25916 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_25916(a,b);
}
});
...
var fexpr__25921 = (function (){var G__25922 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25922__$1)].join('')));

}
})();
return (fexpr__25921.cljs$core$IFn$_invoke$arity$2 ? fexpr__25921.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__25921.call(null,a,b));
}));
/**
