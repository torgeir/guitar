...
var G__15965 = clojure.zip.node(loc);
var fexpr__15964 = cljs.core.cst$kw$zip_SLASH_branch_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__15964.cljs$core$IFn$_invoke$arity$1 ? fexpr__15964.cljs$core$IFn$_invoke$arity$1(G__15965) : fexpr__15964.call(null,G__15965));
});
/**
...
var G__15967 = clojure.zip.node(loc);
var fexpr__15966 = cljs.core.cst$kw$zip_SLASH_children.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__15968 = cljs.core.cst$kw$zip_SLASH_make_DASH_node.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__15968.cljs$core$IFn$_invoke$arity$2 ? fexpr__15968.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__15968.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__15969 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15969,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15969,(1),null);
var vec__15972 = clojure.zip.children(loc);
...
var vec__15975 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15975,(0),null);
var map__15978 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15975,(1),null);
...
var path = map__15978__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15978__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15978__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15978__$1,cljs.core.cst$kw$pnodes);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15978__$1,cljs.core.cst$kw$r);
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15978__$1,cljs.core.cst$kw$changed_QMARK_);
...
var vec__15981 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15981,(0),null);
var map__15984 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15981,(1),null);
...
var path = map__15984__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15984__$1,cljs.core.cst$kw$l);
var vec__15985 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15984__$1,cljs.core.cst$kw$r);
var seq__15986 = cljs.core.seq(vec__15985);
var first__15987 = cljs.core.first(seq__15986);
var seq__15986__$1 = cljs.core.next(seq__15986);
var r = first__15987;
var rnext = seq__15986__$1;
var rs = vec__15985;
...
var vec__15989 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15989,(0),null);
var map__15992 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15989,(1),null);
...
var path = map__15992__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15992__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15992__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return r;
} else {
...
var map__15997 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15994,(1),null);
...
var path = map__15997__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15997__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15997__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var vec__15999 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15999,(0),null);
var map__16002 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15999,(1),null);
...
var path = map__16002__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16002__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16002__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__16004 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16004,(0),null);
var map__16007 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16004,(1),null);
var map__16007__$1 = (((((!((map__16007 == null))))?(((((map__16007.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16007.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16007):map__16007);
var path = map__16007__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16007__$1,cljs.core.cst$kw$l);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__16009 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16009,(0),null);
var map__16012 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16009,(1),null);
...
var path = map__16012__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16012__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16014,(1),null);
...
var len__4736__auto___16020 = arguments.length;
var i__4737__auto___16021 = (0);
while(true){
if((i__4737__auto___16021 < len__4736__auto___16020)){
args__4742__auto__.push((arguments[i__4737__auto___16021]));

var G__16022 = (i__4737__auto___16021 + (1));
i__4737__auto___16021 = G__16022;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq16017){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16018,G__16019,seq16017__$2);
}));
...
var G__16024 = clojure.zip.rightmost(child);
loc__$1 = G__16024;
continue;
} else {
return loc__$1;
...
var map__16028 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16025,(1),null);
...
var path = map__16028__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16028__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16028__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16028__$1,cljs.core.cst$kw$pnodes);
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16028__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Remove at top";
} else {
...
var G__16030 = clojure.zip.rightmost(child);
loc__$1 = G__16030;
continue;
} else {
return loc__$1;
