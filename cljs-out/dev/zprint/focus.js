...
var G__29842 = (cljs.core.truth_(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,cljs.core.cst$kw$left))?skip_to_right_QMARK_:false))?(zprint.focus.next_ssv.cljs$core$IFn$_invoke$arity$2 ? zprint.focus.next_ssv.cljs$core$IFn$_invoke$arity$2(ssv,index) : zprint.focus.next_ssv.call(null,ssv,index)):(index + (1)));
var G__29843 = (function (){var and__4115__auto__ = (function (){var or__4126__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,cljs.core.cst$kw$left);
if(or__4126__auto__){
...
var G__29844 = new_next_nonws_QMARK_;
index = G__29842;
skip_to_right_QMARK_ = G__29843;
next_nonws_QMARK_ = G__29844;
continue;
}
}
break;
...
var G__29845 = zprint.focus.next_ssv(ssv,index);
var G__29846 = (moves - (1));
index = G__29845;
moves = G__29846;
continue;
}
...
var G__29847 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__29848 = cljs.core.next(nwp);
idx = G__29847;
nwp = G__29848;
continue;
}
...
})())?(function (){var fexpr__29849 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return (fexpr__29849.cljs$core$IFn$_invoke$arity$1 ? fexpr__29849.cljs$core$IFn$_invoke$arity$1(ssv_next) : fexpr__29849.call(null,ssv_next));
