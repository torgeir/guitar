...
var G__29782 = (cljs.core.truth_(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,cljs.core.cst$kw$left))?skip_to_right_QMARK_:false))?(zprint.focus.next_ssv.cljs$core$IFn$_invoke$arity$2 ? zprint.focus.next_ssv.cljs$core$IFn$_invoke$arity$2(ssv,index) : zprint.focus.next_ssv.call(null,ssv,index)):(index + (1)));
var G__29783 = (function (){var and__4115__auto__ = (function (){var or__4126__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,cljs.core.cst$kw$left);
if(or__4126__auto__){
...
var G__29784 = new_next_nonws_QMARK_;
index = G__29782;
skip_to_right_QMARK_ = G__29783;
next_nonws_QMARK_ = G__29784;
continue;
}
}
break;
...
var G__29785 = zprint.focus.next_ssv(ssv,index);
var G__29786 = (moves - (1));
index = G__29785;
moves = G__29786;
continue;
}
...
var G__29787 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__29788 = cljs.core.next(nwp);
idx = G__29787;
nwp = G__29788;
continue;
}
...
})())?(function (){var fexpr__29789 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return (fexpr__29789.cljs$core$IFn$_invoke$arity$1 ? fexpr__29789.cljs$core$IFn$_invoke$arity$1(ssv_next) : fexpr__29789.call(null,ssv_next));
