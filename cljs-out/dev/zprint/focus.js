...
var G__30002 = (cljs.core.truth_(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,cljs.core.cst$kw$left))?skip_to_right_QMARK_:false))?(zprint.focus.next_ssv.cljs$core$IFn$_invoke$arity$2 ? zprint.focus.next_ssv.cljs$core$IFn$_invoke$arity$2(ssv,index) : zprint.focus.next_ssv.call(null,ssv,index)):(index + (1)));
var G__30003 = (function (){var and__4115__auto__ = (function (){var or__4126__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,cljs.core.cst$kw$left);
if(or__4126__auto__){
...
var G__30004 = new_next_nonws_QMARK_;
index = G__30002;
skip_to_right_QMARK_ = G__30003;
next_nonws_QMARK_ = G__30004;
continue;
}
}
break;
...
var G__30005 = zprint.focus.next_ssv(ssv,index);
var G__30006 = (moves - (1));
index = G__30005;
moves = G__30006;
continue;
}
...
var G__30007 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__30008 = cljs.core.next(nwp);
idx = G__30007;
nwp = G__30008;
continue;
}
...
})())?(function (){var fexpr__30009 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return (fexpr__30009.cljs$core$IFn$_invoke$arity$1 ? fexpr__30009.cljs$core$IFn$_invoke$arity$1(ssv_next) : fexpr__30009.call(null,ssv_next));
