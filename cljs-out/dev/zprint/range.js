...
if((((cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(row) <= n)) && ((n <= cljs.core.cst$kw$end_DASH_row.cljs$core$IFn$_invoke$arity$1(row))))){
return row;
} else {
if((n < cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(row))){
return (-1);
} else {
return (1);
}
...
return (cljs.core.cst$kw$end_DASH_row.cljs$core$IFn$_invoke$arity$1(row_a) < cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(row_b));
});
/**
...
return (((cljs.core.cst$kw$end_DASH_row.cljs$core$IFn$_invoke$arity$1(row_a) < linenumber)) && ((linenumber < cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(row_b))));
} else {
return (((cljs.core.cst$kw$end_DASH_row.cljs$core$IFn$_invoke$arity$1(row_b) < linenumber)) && ((linenumber < cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(row_a))));
}
} else {
return null;
}
...
if((current_index > (0))){
return cljs.core.cst$kw$beyond_DASH_end;
} else {
return cljs.core.cst$kw$before_DASH_beginning;
}
} else {
if((tries >= max_tries)){
...
var G__30998 = (current_index + row_or_direction__$1);
var G__30999 = current_index;
var G__31000 = (tries + (1));
current_index = G__30998;
previous_index = G__30999;
tries = G__31000;
continue;
}
...
var G__31010 = (function (){var G__31007 = row_vec_index;
var G__31008 = ((zprint.range.abs((row_vec_index - previous_index)) / (2)) | (0));
var fexpr__31006 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(maybe_index,cljs.core.cst$kw$before))?cljs.core._:cljs.core._PLUS_);
return (fexpr__31006.cljs$core$IFn$_invoke$arity$2 ? fexpr__31006.cljs$core$IFn$_invoke$arity$2(G__31007,G__31008) : fexpr__31006.call(null,G__31007,G__31008));
})();
var G__31011 = row_vec_index;
var G__31012 = (tries + (1));
row_vec_index = G__31010;
previous_index = G__31011;
tries = G__31012;
continue;
...
var start_row_idx = (cljs.core.truth_(row_vec__$1)?zprint.range.find_row.cljs$core$IFn$_invoke$arity$3(row_vec__$1,(start__$1 + (1)),dbg_QMARK_):cljs.core.cst$kw$fail);
...
var actual_start = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(start_row_idx,cljs.core.cst$kw$fail))?(-1):((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(start_row_idx,cljs.core.cst$kw$before_DASH_beginning)) && ((!((start__$1 < (0)))))))?(0):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(start_row_idx,cljs.core.cst$kw$before_DASH_beginning))?(-1):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(start_row_idx,(0)))?(0):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(start_row_idx,cljs.core.cst$kw$beyond_DASH_end))?line_count:cljs.core.cst$kw$end_DASH_row.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(row_vec__$1,(start_row_idx - (1))))
)))));
...
var end_row_idx = (cljs.core.truth_(row_vec__$1)?zprint.range.find_row.cljs$core$IFn$_invoke$arity$3(row_vec__$1,(end__$2 + (1)),dbg_QMARK_):cljs.core.cst$kw$fail);
...
var actual_end = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(end_row_idx,cljs.core.cst$kw$fail)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(end_row_idx,cljs.core.cst$kw$beyond_DASH_end))))?line_count:((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(end_row_idx,cljs.core.cst$kw$before_DASH_beginning))?cljs.core.cst$kw$do_DASH_nothing:(function (){var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row_vec__$1,end_row_idx);
if(((end__$2 + (1)) < cljs.core.cst$kw$row.cljs$core$IFn$_invoke$arity$1(end_row))){
...
return (cljs.core.cst$kw$end_DASH_row.cljs$core$IFn$_invoke$arity$1(end_row) - (1));
}
})()
));
var actual_start__$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(actual_end,cljs.core.cst$kw$do_DASH_nothing))?(-1):actual_start__$1);
var actual_end__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(actual_end,cljs.core.cst$kw$do_DASH_nothing))?(-1):actual_end);
