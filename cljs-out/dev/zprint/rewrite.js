...
var G__29682 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__29682;
continue;
} else {
var G__29683 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__29683;
continue;
}
} else {
var G__29684 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__29684;
continue;
}
}
...
var G__29685 = zloc;
var G__29686 = (function (){var G__29687 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__29688 = zloc;
var G__29688__$1 = (((G__29688 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__29688) : rewrite_clj.zip.node.call(null,G__29688)));
if((G__29688__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__29688__$1) : zprint.zutil.edn_STAR_.call(null,G__29688__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__29687) : rewrite_clj.zip.root.call(null,G__29687));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__29685,G__29686) : rewrite_clj.zip.replace.call(null,G__29685,G__29686));
});
/**
...
var G__29689 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__29689;
continue;
}
break;
...
var G__29690 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__29691 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__29690;
out = G__29691;
continue;
} else {
...
var G__29692 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__29693 = cljs.core.next(new_loc);
var G__29694 = replaced_loc;
nloc = G__29692;
new_loc = G__29693;
last_loc = G__29694;
continue;
...
return zprint.rewrite.sort_val((function (){var G__29695 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__29695) : rewrite_clj.zip.down.call(null,G__29695));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__29696_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__29696_SHARP_) : rewrite_clj.zip.tag.call(null,p1__29696_SHARP_)),cljs.core.cst$kw$token)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__29696_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__29696_SHARP_)),cljs.core.cst$kw$dependencies)));
