...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$f,(function (p1__29792_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29792_SHARP_,cljs.core.cst$kw$none)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$reverse], null),p1__29792_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__29793){
var vec__29794 = p__29793;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29794,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29794,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__29797,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29798__$1,cljs.core.cst$kw$style_DASH_map);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29798__$1,cljs.core.cst$kw$focus);
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29798__$1,cljs.core.cst$kw$select);
...
var G__29802 = (function (){var or__4126__auto__ = color;
...
var fexpr__29801 = (function (){var G__29803 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,cljs.core.cst$kw$cursor_DASH_element))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__29803) : style_map.call(null,G__29803));
})();
return (fexpr__29801.cljs$core$IFn$_invoke$arity$1 ? fexpr__29801.cljs$core$IFn$_invoke$arity$1(G__29802) : fexpr__29801.call(null,G__29802));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__29804){
var vec__29805 = p__29804;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29805,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29805,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29805,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__29808){
var vec__29809 = p__29808;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29809,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29809,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29809,(2),null);
...
var G__29812 = cljs.core.next(ssv);
var G__29813 = (this_ssv == null);
var G__29814 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__29815 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__29812;
doing_nil_QMARK_ = G__29813;
last_elide = G__29814;
out = G__29815;
continue;
}
...
var vec__29819 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29819,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29819,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29819,(2),null);
...
var G__29822 = cljs.core.next(remaining_cvec);
var G__29823 = new_idx;
var G__29824 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__29822;
idx = G__29823;
out = G__29824;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__29835,cursor_vec){
var vec__29836 = p__29835;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29836,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29836,(1),null);
var focus_vec = vec__29836;
...
var vec__29839 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29839,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29839,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__29842){
var vec__29843 = p__29842;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29843,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__29849,existing_count){
var vec__29850 = p__29849;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29850,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29850,(1),null);
...
return cljs.core.filterv((function (p1__29846_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__29846_SHARP_))));
...
var vec__29857 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29857,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29857,(1),null);
var cvec_element = vec__29857;
if((cvec_element == null)){
var G__29860 = cljs.core.next(cvec_nl);
var G__29861 = (idx + (1));
var G__29862 = start;
var G__29863 = out;
cvec_nl = G__29860;
...
var G__29864 = cljs.core.next(cvec_nl);
var G__29865 = (idx + (1));
var G__29866 = idx;
var G__29867 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__29864;
idx = G__29865;
start = G__29866;
out = G__29867;
...
var G__29868 = cljs.core.next(cvec_nl);
var G__29869 = (idx + (1));
var G__29870 = (idx + (1));
var G__29871 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__29868;
idx = G__29869;
start = G__29870;
out = G__29871;
...
var G__29872 = cljs.core.next(cvec_nl);
var G__29873 = (idx + (1));
var G__29874 = idx;
var G__29875 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__29872;
idx = G__29873;
start = G__29874;
out = G__29875;
...
var G__29876 = cljs.core.next(cvec_nl);
var G__29877 = (idx + (1));
var G__29878 = start;
var G__29879 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__29876;
idx = G__29877;
start = G__29878;
out = G__29879;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__29881_SHARP_,p2__29880_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__29880_SHARP_)){
return cljs.core.reduced(p1__29881_SHARP_);
} else {
return (p1__29881_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__29882,p__29883){
var vec__29884 = p__29882;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29884,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29884,(1),null);
var vec__29887 = p__29883;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29887,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29887,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__29891,cvec,focus_vec){
...
var options = map__29892__$1;
var map__29893 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29892__$1,cljs.core.cst$kw$output);
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29893__$1,cljs.core.cst$kw$focus);
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29893__$1,cljs.core.cst$kw$lines);
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29893__$1,cljs.core.cst$kw$paths);
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29890_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__29890_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
