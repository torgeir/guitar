...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$f,(function (p1__30040_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30040_SHARP_,cljs.core.cst$kw$none)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$reverse], null),p1__30040_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__30041){
var vec__30042 = p__30041;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30042,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30042,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__30045,s,color,element,idx){
var map__30046 = p__30045;
var map__30046__$1 = (((((!((map__30046 == null))))?(((((map__30046.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30046.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30046):map__30046);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30046__$1,cljs.core.cst$kw$style_DASH_map);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30046__$1,cljs.core.cst$kw$focus);
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30046__$1,cljs.core.cst$kw$select);
...
var G__30050 = (function (){var or__4126__auto__ = color;
...
var fexpr__30049 = (function (){var G__30051 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,cljs.core.cst$kw$cursor_DASH_element))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__30051) : style_map.call(null,G__30051));
})();
return (fexpr__30049.cljs$core$IFn$_invoke$arity$1 ? fexpr__30049.cljs$core$IFn$_invoke$arity$1(G__30050) : fexpr__30049.call(null,G__30050));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__30052){
var vec__30053 = p__30052;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30053,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30053,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30053,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__30056){
var vec__30057 = p__30056;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(2),null);
...
var G__30060 = cljs.core.next(ssv);
var G__30061 = (this_ssv == null);
var G__30062 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__30063 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__30060;
doing_nil_QMARK_ = G__30061;
last_elide = G__30062;
out = G__30063;
continue;
}
...
var vec__30067 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30067,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30067,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30067,(2),null);
...
var G__30070 = cljs.core.next(remaining_cvec);
var G__30071 = new_idx;
var G__30072 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__30070;
idx = G__30071;
out = G__30072;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__30083,cursor_vec){
var vec__30084 = p__30083;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30084,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30084,(1),null);
var focus_vec = vec__30084;
...
var vec__30087 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30087,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30087,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__30090){
var vec__30091 = p__30090;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30091,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30091,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__30097,existing_count){
var vec__30098 = p__30097;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30098,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30098,(1),null);
...
return cljs.core.filterv((function (p1__30094_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__30094_SHARP_))));
...
var vec__30105 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30105,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30105,(1),null);
var cvec_element = vec__30105;
if((cvec_element == null)){
var G__30108 = cljs.core.next(cvec_nl);
var G__30109 = (idx + (1));
var G__30110 = start;
var G__30111 = out;
cvec_nl = G__30108;
...
var G__30112 = cljs.core.next(cvec_nl);
var G__30113 = (idx + (1));
var G__30114 = idx;
var G__30115 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__30112;
idx = G__30113;
start = G__30114;
out = G__30115;
...
var G__30116 = cljs.core.next(cvec_nl);
var G__30117 = (idx + (1));
var G__30118 = (idx + (1));
var G__30119 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__30116;
idx = G__30117;
start = G__30118;
out = G__30119;
...
var G__30120 = cljs.core.next(cvec_nl);
var G__30121 = (idx + (1));
var G__30122 = idx;
var G__30123 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__30120;
idx = G__30121;
start = G__30122;
out = G__30123;
...
var G__30124 = cljs.core.next(cvec_nl);
var G__30125 = (idx + (1));
var G__30126 = start;
var G__30127 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__30124;
idx = G__30125;
start = G__30126;
out = G__30127;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__30129_SHARP_,p2__30128_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__30128_SHARP_)){
return cljs.core.reduced(p1__30129_SHARP_);
} else {
return (p1__30129_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__30130,p__30131){
var vec__30132 = p__30130;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30132,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30132,(1),null);
var vec__30135 = p__30131;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30135,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30135,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__30139,cvec,focus_vec){
...
var map__30141 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30140__$1,cljs.core.cst$kw$output);
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30141__$1,cljs.core.cst$kw$focus);
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30141__$1,cljs.core.cst$kw$lines);
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30141__$1,cljs.core.cst$kw$paths);
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30138_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__30138_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
