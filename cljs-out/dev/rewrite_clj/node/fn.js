...
return (new cljs.core.List(null,cljs.core.cst$sym$fn_STAR_,(new cljs.core.List(null,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(syms,(cljs.core.truth_(vararg)?(new cljs.core.List(null,cljs.core.cst$sym$_AMPERSAND_,(new cljs.core.List(null,vararg,null,(1),null)),(2),null)):null))),(new cljs.core.List(null,body,null,(1),null)),(2),null)),(3),null));
});
/**
...
var syms = (function (){var iter__4529__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__15657(s__15658){
return (new cljs.core.LazySeq(null,(function (){
var s__15658__$1 = s__15658;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__15658__$1);
if(temp__5720__auto__){
var s__15658__$2 = temp__5720__auto__;
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__15659);
...
cljs.core.chunk_append(b__15660,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15660),rewrite_clj$node$fn$fn_walk_$_iter__15657(cljs.core.chunk_rest(s__15658__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15660),null);
}
} else {
var i = cljs.core.first(s__15658__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__15657(cljs.core.rest(s__15658__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__15656_SHARP_){
var or__4126__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__15656_SHARP_);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return p1__15656_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k15663,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k15663,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__15668){
var vec__15669 = p__15668;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15669,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15669,(1),null);
...
return cljs.core.pr_sequential_writer(writer__4395__auto__,pr_pair__4397__auto__,"#rewrite-clj.node.fn.FnNode{",", ","}",opts__4396__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$children,self__.children],null))], null),self__.__extmap));
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__15662){
var self__ = this;
var G__15662__$1 = this;
return (new cljs.core.RecordIter((0),G__15662__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$children], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4238__auto____$1 = (function (){var fexpr__15672 = (function (coll__4377__auto__){
return (-1740346885 ^ cljs.core.hash_unordered_coll(coll__4377__auto__));
});
return fexpr__15672(this__4376__auto____$1);
})();
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this15664,other15665){
var self__ = this;
var this15664__$1 = this;
return (((!((other15665 == null)))) && ((this15664__$1.constructor === other15665.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this15664__$1.children,other15665.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this15664__$1.__extmap,other15665.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__15662){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__15673 = cljs.core.keyword_identical_QMARK_;
var expr__15674 = k__4388__auto__;
if(cljs.core.truth_((function (){var G__15676 = cljs.core.cst$kw$children;
...
return (new rewrite_clj.node.fn.FnNode(G__15662,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__15662),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__15662){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__15662,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__15666){
var extmap__4419__auto__ = (function (){var G__15678 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__15666,cljs.core.cst$kw$children);
if(cljs.core.record_QMARK_(G__15666)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__15678);
} else {
return G__15678;
}
})();
return (new rewrite_clj.node.fn.FnNode(cljs.core.cst$kw$children.cljs$core$IFn$_invoke$arity$1(G__15666),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
