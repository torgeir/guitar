...
var pred__38857 = cljs.core._EQ_;
var expr__38858 = v;
if(cljs.core.truth_((function (){var G__38860 = cljs.core.cst$kw$light;
var G__38861 = expr__38858;
return (pred__38857.cljs$core$IFn$_invoke$arity$2 ? pred__38857.cljs$core$IFn$_invoke$arity$2(G__38860,G__38861) : pred__38857.call(null,G__38860,G__38861));
})())){
return cljs.core.cst$kw$dark;
} else {
if(cljs.core.truth_((function (){var G__38862 = cljs.core.cst$kw$dark;
var G__38863 = expr__38858;
return (pred__38857.cljs$core$IFn$_invoke$arity$2 ? pred__38857.cljs$core$IFn$_invoke$arity$2(G__38862,G__38863) : pred__38857.call(null,G__38862,G__38863));
})())){
...
guitar.core.state_link = (function guitar$core$state_link(p__38864){
var vec__38865 = p__38864;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38865,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38865,(1),null);
...
var strings_notes = cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.map,(function (p1__38868_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$note,p1__38868_SHARP_], null));
...
}),'className':"button button--huge"},["Guess notes"])]),daiquiri.interpreter.interpret((function (){var G__38902 = cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(rum.core.react(state));
var G__38903 = strings_notes;
var G__38904 = mode_state;
var fexpr__38901 = (function (){var pred__38905 = cljs.core._EQ_;
var expr__38906 = mode;
if(cljs.core.truth_((function (){var G__38908 = cljs.core.cst$kw$guess;
var G__38909 = expr__38906;
return (pred__38905.cljs$core$IFn$_invoke$arity$2 ? pred__38905.cljs$core$IFn$_invoke$arity$2(G__38908,G__38909) : pred__38905.call(null,G__38908,G__38909));
})())){
return guitar.modes.guess.guess_fretboard_notes;
} else {
if(cljs.core.truth_((function (){var G__38910 = cljs.core.cst$kw$explore;
var G__38911 = expr__38906;
return (pred__38905.cljs$core$IFn$_invoke$arity$2 ? pred__38905.cljs$core$IFn$_invoke$arity$2(G__38910,G__38911) : pred__38905.call(null,G__38910,G__38911));
})())){
...
return (fexpr__38901.cljs$core$IFn$_invoke$arity$3 ? fexpr__38901.cljs$core$IFn$_invoke$arity$3(G__38902,G__38903,G__38904) : fexpr__38901.call(null,G__38902,G__38903,G__38904));
})()),(function (){var attrs38873 = (function (){var G__38912 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),guitar.setup.tuning))?"6-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs38873))?daiquiri.interpreter.attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["buttons"], null)], null),attrs38873], 0))):{'className':"buttons"}),((cljs.core.map_QMARK_(attrs38873))?[daiquiri.interpreter.interpret((function (){var G__38916 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning))))?"7-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
...
})())]:[daiquiri.interpreter.interpret(attrs38873),daiquiri.interpreter.interpret((function (){var G__38924 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning))))?"7-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,cljs.core.cst$kw$tuning,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning)));
})], null);
var G__38925 = "7-string";
...
})()),daiquiri.interpreter.interpret((function (){var G__38928 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic("g","b",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([guitar.setup.tuning], 0)))))?"8-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,cljs.core.cst$kw$tuning,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic("g","b",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([guitar.setup.tuning], 0))));
})], null);
var G__38929 = "8-string";
return (guitar.buttons.button.cljs$core$IFn$_invoke$arity$2 ? guitar.buttons.button.cljs$core$IFn$_invoke$arity$2(G__38928,G__38929) : guitar.buttons.button.call(null,G__38928,G__38929));
})())]));
