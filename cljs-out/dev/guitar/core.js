...
guitar.core.state = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$tuning,guitar.setup.tuning,cljs.core.cst$kw$theme,cljs.core.cst$kw$dark,cljs.core.cst$kw$mode,(function (){var pred__38649 = cljs.core._EQ_;
var expr__38650 = guitar.core.location_hash.cljs$core$IFn$_invoke$arity$0();
if(cljs.core.truth_((pred__38649.cljs$core$IFn$_invoke$arity$2 ? pred__38649.cljs$core$IFn$_invoke$arity$2("guess",expr__38650) : pred__38649.call(null,"guess",expr__38650)))){
return cljs.core.cst$kw$guess;
} else {
if(cljs.core.truth_((pred__38649.cljs$core$IFn$_invoke$arity$2 ? pred__38649.cljs$core$IFn$_invoke$arity$2("explore",expr__38650) : pred__38649.call(null,"explore",expr__38650)))){
...
cljs.core.add_watch(guitar.core.state,cljs.core.cst$kw$mode,(function (_,___$1,___$2,p__38652){
...
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38653__$1,cljs.core.cst$kw$mode);
...
var expr__38656 = v;
if(cljs.core.truth_((function (){var G__38658 = cljs.core.cst$kw$light;
var G__38659 = expr__38656;
return (pred__38655.cljs$core$IFn$_invoke$arity$2 ? pred__38655.cljs$core$IFn$_invoke$arity$2(G__38658,G__38659) : pred__38655.call(null,G__38658,G__38659));
})())){
return cljs.core.cst$kw$dark;
} else {
if(cljs.core.truth_((function (){var G__38660 = cljs.core.cst$kw$dark;
var G__38661 = expr__38656;
return (pred__38655.cljs$core$IFn$_invoke$arity$2 ? pred__38655.cljs$core$IFn$_invoke$arity$2(G__38660,G__38661) : pred__38655.call(null,G__38660,G__38661));
})())){
...
var strings_notes = cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.map,(function (p1__38662_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$note,p1__38662_SHARP_], null));
...
}),'className':"button button--huge"},["Guess notes"])]),daiquiri.interpreter.interpret((function (){var G__38694 = cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(rum.core.react(state));
var G__38695 = strings_notes;
var G__38696 = mode_state;
var fexpr__38693 = (function (){var pred__38697 = cljs.core._EQ_;
var expr__38698 = mode;
if(cljs.core.truth_((function (){var G__38700 = cljs.core.cst$kw$guess;
...
if(cljs.core.truth_((function (){var G__38702 = cljs.core.cst$kw$explore;
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__38698)].join('')));
}
}
})();
return (fexpr__38693.cljs$core$IFn$_invoke$arity$3 ? fexpr__38693.cljs$core$IFn$_invoke$arity$3(G__38694,G__38695,G__38696) : fexpr__38693.call(null,G__38694,G__38695,G__38696));
})()),(function (){var attrs38667 = (function (){var G__38704 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),guitar.setup.tuning))?"6-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs38667))?daiquiri.interpreter.attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["buttons"], null)], null),attrs38667], 0))):{'className':"buttons"}),((cljs.core.map_QMARK_(attrs38667))?[daiquiri.interpreter.interpret((function (){var G__38708 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning))))?"7-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
...
var G__38713 = "8-string";
return (guitar.buttons.button.cljs$core$IFn$_invoke$arity$2 ? guitar.buttons.button.cljs$core$IFn$_invoke$arity$2(G__38712,G__38713) : guitar.buttons.button.call(null,G__38712,G__38713));
})())]:[daiquiri.interpreter.interpret(attrs38667),daiquiri.interpreter.interpret((function (){var G__38716 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning))))?"7-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,cljs.core.cst$kw$tuning,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning)));
})], null);
var G__38717 = "7-string";
return (guitar.buttons.button.cljs$core$IFn$_invoke$arity$2 ? guitar.buttons.button.cljs$core$IFn$_invoke$arity$2(G__38716,G__38717) : guitar.buttons.button.call(null,G__38716,G__38717));
})()),daiquiri.interpreter.interpret((function (){var G__38720 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic("g","b",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([guitar.setup.tuning], 0)))))?"8-string":null),cljs.core.cst$kw$on_DASH_click,(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,cljs.core.cst$kw$tuning,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic("g","b",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([guitar.setup.tuning], 0))));
})], null);
var G__38721 = "8-string";
return (guitar.buttons.button.cljs$core$IFn$_invoke$arity$2 ? guitar.buttons.button.cljs$core$IFn$_invoke$arity$2(G__38720,G__38721) : guitar.buttons.button.call(null,G__38720,G__38721));
})())]));
})(),null]);
