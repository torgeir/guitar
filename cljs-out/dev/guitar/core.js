...
guitar.core.state = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$tuning,guitar.setup.tuning,cljs.core.cst$kw$theme,cljs.core.cst$kw$dark,cljs.core.cst$kw$mode,(function (){var pred__38687 = cljs.core._EQ_;
var expr__38688 = guitar.core.location_hash.cljs$core$IFn$_invoke$arity$0();
if(cljs.core.truth_((pred__38687.cljs$core$IFn$_invoke$arity$2 ? pred__38687.cljs$core$IFn$_invoke$arity$2("guess",expr__38688) : pred__38687.call(null,"guess",expr__38688)))){
return cljs.core.cst$kw$guess;
} else {
if(cljs.core.truth_((pred__38687.cljs$core$IFn$_invoke$arity$2 ? pred__38687.cljs$core$IFn$_invoke$arity$2("explore",expr__38688) : pred__38687.call(null,"explore",expr__38688)))){
...
cljs.core.add_watch(guitar.core.state,cljs.core.cst$kw$mode,(function (_,___$1,___$2,p__38690){
...
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38691__$1,cljs.core.cst$kw$mode);
...
var expr__38694 = v;
if(cljs.core.truth_((function (){var G__38696 = cljs.core.cst$kw$light;
...
if(cljs.core.truth_((function (){var G__38698 = cljs.core.cst$kw$dark;
...
var strings_notes = cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.map,(function (p1__38700_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$note,p1__38700_SHARP_], null));
...
}),'className':"button button--huge"},["Guess notes"])]),daiquiri.interpreter.interpret((function (){var G__38732 = cljs.core.cst$kw$tuning.cljs$core$IFn$_invoke$arity$1(rum.core.react(state));
var G__38733 = strings_notes;
var G__38734 = mode_state;
var fexpr__38731 = (function (){var pred__38735 = cljs.core._EQ_;
var expr__38736 = mode;
if(cljs.core.truth_((function (){var G__38738 = cljs.core.cst$kw$guess;
var G__38739 = expr__38736;
return (pred__38735.cljs$core$IFn$_invoke$arity$2 ? pred__38735.cljs$core$IFn$_invoke$arity$2(G__38738,G__38739) : pred__38735.call(null,G__38738,G__38739));
})())){
return guitar.modes.guess.guess_fretboard_notes;
} else {
if(cljs.core.truth_((function (){var G__38740 = cljs.core.cst$kw$explore;
var G__38741 = expr__38736;
return (pred__38735.cljs$core$IFn$_invoke$arity$2 ? pred__38735.cljs$core$IFn$_invoke$arity$2(G__38740,G__38741) : pred__38735.call(null,G__38740,G__38741));
})())){
return guitar.modes.explore.visualize_scales;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__38736)].join('')));
}
}
})();
return (fexpr__38731.cljs$core$IFn$_invoke$arity$3 ? fexpr__38731.cljs$core$IFn$_invoke$arity$3(G__38732,G__38733,G__38734) : fexpr__38731.call(null,G__38732,G__38733,G__38734));
})()),(function (){var attrs38705 = (function (){var G__38742 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
...
var G__38743 = "6-string";
return (guitar.buttons.button.cljs$core$IFn$_invoke$arity$2 ? guitar.buttons.button.cljs$core$IFn$_invoke$arity$2(G__38742,G__38743) : guitar.buttons.button.call(null,G__38742,G__38743));
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs38705))?daiquiri.interpreter.attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["buttons"], null)], null),attrs38705], 0))):{'className':"buttons"}),((cljs.core.map_QMARK_(attrs38705))?[daiquiri.interpreter.interpret((function (){var G__38746 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
...
})()),daiquiri.interpreter.interpret((function (){var G__38750 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
...
})())]:[daiquiri.interpreter.interpret(attrs38705),daiquiri.interpreter.interpret((function (){var G__38754 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,cljs.core.cst$kw$tuning,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2("b",guitar.setup.tuning)));
})], null);
var G__38755 = "7-string";
...
})()),daiquiri.interpreter.interpret((function (){var G__38758 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,cljs.core.cst$kw$tuning,cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic("g","b",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([guitar.setup.tuning], 0))));
})], null);
var G__38759 = "8-string";
