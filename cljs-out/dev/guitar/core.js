...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(n),(function (){var pred__15039 = cljs.core._EQ_;
var expr__15040 = (cljs.core.last(cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)) | (0));
if(cljs.core.truth_((pred__15039.cljs$core$IFn$_invoke$arity$2 ? pred__15039.cljs$core$IFn$_invoke$arity$2((1),expr__15040) : pred__15039.call(null,(1),expr__15040)))){
return "st";
} else {
if(cljs.core.truth_((pred__15039.cljs$core$IFn$_invoke$arity$2 ? pred__15039.cljs$core$IFn$_invoke$arity$2((2),expr__15040) : pred__15039.call(null,(2),expr__15040)))){
return "nd";
} else {
if(cljs.core.truth_((pred__15039.cljs$core$IFn$_invoke$arity$2 ? pred__15039.cljs$core$IFn$_invoke$arity$2((3),expr__15040) : pred__15039.call(null,(3),expr__15040)))){
return "rd";
} else {
return "th";
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__15042_SHARP_,p2__15043_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__15042_SHARP_,cljs.core.nth.cljs$core$IFn$_invoke$arity$2(from,p2__15043_SHARP_));
...
var attrs15044 = note;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs15044))?daiquiri.interpreter.attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["guitar-nut"], null)], null),attrs15044], 0))):{'className':"guitar-nut"}),((cljs.core.map_QMARK_(attrs15044))?null:[daiquiri.interpreter.interpret(attrs15044)]));
}),null,"guitar.core/guitar-nut");
guitar.core.guitar_fret = rum.core.lazy_build(rum.core.build_defc,(function (note){
var attrs15045 = note;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs15045))?daiquiri.interpreter.attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["guitar-fret"], null)], null),attrs15045], 0))):{'className':"guitar-fret"}),((cljs.core.map_QMARK_(attrs15045))?null:[daiquiri.interpreter.interpret(attrs15045)]));
}),null,"guitar.core/guitar-fret");
guitar.core.guitar_string = rum.core.lazy_build(rum.core.build_defc,(function (visible,notes){
var attrs15050 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__15047_SHARP_,p2__15046_SHARP_){
return rum.core.with_key((guitar.core.guitar_fret.cljs$core$IFn$_invoke$arity$1 ? guitar.core.guitar_fret.cljs$core$IFn$_invoke$arity$1(p2__15046_SHARP_) : guitar.core.guitar_fret.call(null,p2__15046_SHARP_)),["key-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__15047_SHARP_)].join(''));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(visible)?cljs.core.identity:cljs.core.constantly(guitar.core.nbsp)),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((1),notes))),rum.core.with_key((function (){var G__15051 = (cljs.core.truth_(visible)?cljs.core.first(notes):guitar.core.nbsp);
return (guitar.core.guitar_nut.cljs$core$IFn$_invoke$arity$1 ? guitar.core.guitar_nut.cljs$core$IFn$_invoke$arity$1(G__15051) : guitar.core.guitar_nut.call(null,G__15051));
})(),"key-nut"));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs15050))?daiquiri.interpreter.attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["guitar-string"], null)], null),attrs15050], 0))):{'className':"guitar-string"}),((cljs.core.map_QMARK_(attrs15050))?null:[daiquiri.interpreter.interpret(attrs15050)]));
...
}),'className':"guitar"},[daiquiri.interpreter.interpret(cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__15053_SHARP_,p2__15052_SHARP_){
return rum.core.with_key((function (){var G__15056 = cljs.core.cst$kw$show_DASH_notes.cljs$core$IFn$_invoke$arity$1(rum.core.react(guess));
var G__15057 = p2__15052_SHARP_;
return (guitar.core.guitar_string.cljs$core$IFn$_invoke$arity$2 ? guitar.core.guitar_string.cljs$core$IFn$_invoke$arity$2(G__15056,G__15057) : guitar.core.guitar_string.call(null,G__15056,G__15057));
})(),p1__15053_SHARP_);
