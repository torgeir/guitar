...
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(note,cljs.core.cst$kw$color,(5)):((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(string,cljs.core.cst$kw$string.cljs$core$IFn$_invoke$arity$1(locate))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$note.cljs$core$IFn$_invoke$arity$1(note),cljs.core.cst$kw$note.cljs$core$IFn$_invoke$arity$1(locate)))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(note,cljs.core.cst$kw$color,(1)):((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fret,cljs.core.cst$kw$fret.cljs$core$IFn$_invoke$arity$1(attempt))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(string,cljs.core.cst$kw$string.cljs$core$IFn$_invoke$arity$1(attempt)))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(note,cljs.core.cst$kw$color,(0)):note
)))], null);
}),string_notes);
