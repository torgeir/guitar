...
var map__20415 = top_item;
var map__20415__$1 = (((((!((map__20415 == null))))?(((((map__20415.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20415.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20415):map__20415);
...
}catch (e20414){var _e = e20414;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___20417 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___20417)){
var seen_errors_20418 = temp__5718__auto___20417;
if(cljs.core.truth_(seen_errors_20418.has(self))){
} else {
seen_errors_20418.add(self);

var temp__5720__auto___20419 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___20419)){
var sense_20420 = temp__5720__auto___20419;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20420)].join(''));
} else {
}
}
} else {
