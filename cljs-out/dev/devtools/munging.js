...
var o15588 = temp__5718__auto__;
var temp__5718__auto____$1 = (o15588["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15589 = temp__5718__auto____$1;
return (o15589["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14592__auto__ = f;
return (o__14592__auto__["toString"]).call(o__14592__auto__);
} else {
return "";
}
}catch (e15590){var _ = e15590;
return "";
}});
...
try{var o__14592__auto___15592 = t;
(o__14592__auto___15592["cljs$lang$ctorPrWriter"]).call(o__14592__auto___15592,t,writer);
}catch (e15591){var __15593 = e15591;
}
...
var char_code = (function (){var o__14592__auto__ = (new String(char$));
return (o__14592__auto__["charCodeAt"]).call(o__14592__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14592__auto__ = String;
return (o__14592__auto__["fromCharCode"]).call(o__14592__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15594 = num_code;
switch (G__15594) {
case (1):
return (185);
...
var o__14592__auto__ = String;
return (o__14592__auto__["fromCharCode"]).call(o__14592__auto__,superscript_code);
});
/**
...
}catch (e15596){var _e__14599__auto__ = e15596;
return false;
}})())){
...
var vec__15597 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15597,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o15600 = temp__5718__auto__;
var temp__5718__auto____$1 = (o15600["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15601 = temp__5718__auto____$1;
return (o15601["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___15608 = arguments.length;
var i__4737__auto___15609 = (0);
while(true){
if((i__4737__auto___15609 < len__4736__auto___15608)){
args__4742__auto__.push((arguments[i__4737__auto___15609]));

var G__15610 = (i__4737__auto___15609 + (1));
i__4737__auto___15609 = G__15610;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15604){
var vec__15605 = p__15604;
var ns_detector = cljs.core.nth.call(null,vec__15605,(0),null);
...
var G__15611 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15612 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15611;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15602){
var G__15603 = cljs.core.first.call(null,seq15602);
var seq15602__$1 = cljs.core.next.call(null,seq15602);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15603,seq15602__$1);
}));
...
var vec__15616 = cljs.core.split_with.call(null,(function (p1__15615_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15615_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15616,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15616,(1),null);
...
var vec__15622 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15622,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15622,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15625 = cljs.core.rest.call(null,remaining_tokens);
var G__15626 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15625;
name_tokens = G__15626;
continue;
} else {
...
var vec__15629 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15629,(0),null);
var arity = cljs.core.nth.call(null,vec__15629,(1),null);
var vec__15632 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15632,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15632,(1),null);
var vec__15635 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15635,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15635,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15635,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15635,(3),null);
...
var vec__15641 = result;
var munged_ns = cljs.core.nth.call(null,vec__15641,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15641,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15641,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15641,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15641,(4),null);
var arity = cljs.core.nth.call(null,vec__15641,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__15645 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__15645,(0),null);
var args = cljs.core.nth.call(null,vec__15645,(1),null);
var vec__15648 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15648,(0),null);
var name = cljs.core.nth.call(null,vec__15648,(1),null);
...
var G__15651 = (arity + (1));
var G__15652 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15653){
var vec__15654 = p__15653;
var arity = cljs.core.nth.call(null,vec__15654,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15654,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__15657_SHARP_){
return cljs.core.get.call(null,arities,p1__15657_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__15658_SHARP_){
return cljs.core.drop.call(null,(2),p1__15658_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15661){
var vec__15662 = p__15661;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15662,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15659){
var G__15660 = cljs.core.first.call(null,seq15659);
var seq15659__$1 = cljs.core.next.call(null,seq15659);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15660,seq15659__$1);
}));
...
var map__15670 = options;
var map__15670__$1 = (((((!((map__15670 == null))))?(((((map__15670.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15670.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15670):map__15670);
var include_ns_QMARK_ = cljs.core.get.call(null,map__15670__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15670__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15670__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15670__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15671 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15671,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15671,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15671,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15671,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15671,(4),null);
var arity = cljs.core.nth.call(null,vec__15671,(5),null);
...
var o__14592__auto__ = f;
return (o__14592__auto__["getBasis"]).call(o__14592__auto__);
});
/**
...
}catch (e15675){var _e__14599__auto__ = e15675;
...
var G__15676 = (obj[cljs.core.first.call(null,path)]);
var G__15677 = cljs.core.rest.call(null,path);
obj = G__15676;
path = G__15677;
continue;
} else {
...
var _STAR_ = (function (accum,p__15678){
var vec__15679 = p__15678;
var bit = cljs.core.nth.call(null,vec__15679,(0),null);
var protocol = cljs.core.nth.call(null,vec__15679,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15682){
var vec__15683 = p__15682;
var ns = cljs.core.nth.call(null,vec__15683,(0),null);
var name = cljs.core.nth.call(null,vec__15683,(1),null);
var selector = cljs.core.nth.call(null,vec__15683,(2),null);
...
var post_process = (function (p__15687){
var vec__15688 = p__15687;
var munged_name = cljs.core.nth.call(null,vec__15688,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15688,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__15686_SHARP_){
return (obj[cljs.core.first.call(null,p1__15686_SHARP_)]);
}),sorted_matches);
