...
var G__15711 = devtools.prefs.pref.call(null,v);
v = G__15711;
continue;
} else {
return v;
...
}catch (e15714){var _e__14599__auto__ = e15714;
return false;
}})();
...
}catch (e15718){var _e__14599__auto__ = e15718;
return false;
}})();
...
}catch (e15720){var _e__14599__auto__ = e15720;
return false;
}}
}
});
...
var vec__15722 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15722,(0),null);
var name = cljs.core.nth.call(null,vec__15722,(1),null);
...
return cljs.core.some.call(null,(function (p1__15725_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15725_SHARP_);
}),template);
});
