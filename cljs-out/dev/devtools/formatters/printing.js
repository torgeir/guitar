...
var len__4736__auto___15768 = arguments.length;
var i__4737__auto___15769 = (0);
while(true){
if((i__4737__auto___15769 < len__4736__auto___15768)){
args__4742__auto__.push((arguments[i__4737__auto___15769]));

var G__15770 = (i__4737__auto___15769 + (1));
i__4737__auto___15769 = G__15770;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15765){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15766,G__15767,seq15765__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15771_SHARP_){
return (!((cljs.core.meta.call(null,p1__15771_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__15772__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15776){var _e__14599__auto__ = e15776;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e15778){var _e__14599__auto__ = e15778;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15780 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15781 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15781);

try{var map__15782 = opts;
var map__15782__$1 = (((((!((map__15782 == null))))?(((((map__15782.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15782.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15782):map__15782);
var markup_db = cljs.core.get.call(null,map__15782__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15780);
}});
...
var temp__5718__auto___15787 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___15787)){
var managed_print_level_15788 = temp__5718__auto___15787;
var _STAR_print_level_STAR__orig_val__15785_15789 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15786_15790 = managed_print_level_15788;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15786_15790);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__15784_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15784_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15785_15789);
}} else {
job_fn.call(null);
}
