...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__13683,cljs.core.cst$kw$class,daiquiri.normalize.normalize_class);
} else {
return G__13683;
}
});
...
var len__4736__auto___13686 = arguments.length;
var i__4737__auto___13687 = (0);
while(true){
if((i__4737__auto___13687 < len__4736__auto___13686)){
args__4742__auto__.push((arguments[i__4737__auto___13687]));

var G__13688 = (i__4737__auto___13687 + (1));
i__4737__auto___13687 = G__13688;
continue;
} else {
}
break;
...
var G__13685 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13685,cljs.core.cst$kw$class,cljs.core.vec(classes));
} else {
return G__13685;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq13684){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13684));
}));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13691,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13691,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__13689_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__13689_SHARP_))){
return p1__13689_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__13690_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__13690_SHARP_))){
return daiquiri.normalize.strip_css(p1__13690_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__13695){
...
var tag = first__13698;
var content = seq__13697__$1;
...
var vec__13699 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13699,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13699,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13699,(2),null);
var tag_attrs = (function (){var G__13702 = cljs.core.PersistentArrayMap.EMPTY;
var G__13702__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13702,cljs.core.cst$kw$id,id):G__13702);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13702__$1,cljs.core.cst$kw$class,class$);
} else {
return G__13702__$1;
}
})();
